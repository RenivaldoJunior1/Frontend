...
export default function CadastroUsuarioScreen() {
  ...
  const handleCadastro = async () => {
    ...
    //Verificacao se o CPF tem no minimo 11 caracteres
    if (cpf < 11) {
      Alert.alert('Erro', 'O CPF precisa ter 11 dígitos')
      return;
    }

    //Verificacao se o telefone tem no minimo 8 caracteres
    if (telefone < 8) {
      Alert.alert('Erro', 'O telefone deve conter pelo menos 8 dígitos')
      return;
    }
          ...
          <LinearGradient colors={['#EB5375', '#E34D76', '#D84477', '#C73578']} style={styles.card}>
            ...
            >
              <View style={styles.titleContainer}>
                ...
                <Text style={styles.continueTitle}>Usuário</Text>
              </View>
                  ...
                  <View key={index} style={styles.inputContainer}>
                    ...
                    <TextInput 
                      ...
                      onBlur={() => {
                        ...
                        //Garantir que o CPF tem no mínimo 11 caracteres
                        if (input.label === 'CPF' && cpf.length < 11) {
                          Alert.alert('Erro', 'O CPF precisa ter 11 dígitos')
                        }

                        //Garantir que o telefone tem no mínimo 8 caracteres
                        if (input.label === 'Telefone' && telefone.length < 8) {
                          Alert.alert('Erro', 'O telefone deve conter pelo menos 8 dígitos')
                        }
                      }}
